...
export const SET_CURR_USER = 'set_curr_user';             // 当前好友资料
export const SET_CURR_USER_CHICK = 'set_curr_user_chick'; // 当前好友小鸡资料
...
export const SET_YS_GACHA_LIST = 'set_ys_gacha_list';   // 添加卡池详情信息到卡池详情列表
